...
class Player:#this is the class
    ...
    def playerScore(self):#tells player their score
        print("You're random number was " + str(self.randomNumber) + ". It took you the least amount of attempts, with an astounding " + str(self.numberOfAttempts) + " attempts! Congratulations!")
