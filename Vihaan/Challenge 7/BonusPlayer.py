...
class Player:#this is the class
    ...
    def tieChecker(self, players):
      if players[0].numberOfAttempts == players[1].numberOfAttempts:
          return True
      else:
          return False

    def playerTie(self):
        print(self.playerName + ", you're number was " + str(self.randomNumber) + ". You took " + str(self.numberOfAttempts) + " attempts to find it! Nice!")
        return "Thank you for playing!"